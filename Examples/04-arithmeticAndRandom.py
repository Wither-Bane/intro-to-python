...
print(number1,"integer-divided by",number2,"is",integer_division_result) 
...
names = ["pikachu", "Charzard", "Lucario"]

print("For my pokemon, I choose you, "+ random.choice(names) +"!")
